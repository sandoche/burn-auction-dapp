...
export const testnetConfigByChain: Record<string, ChainRegistry['configurations']> = {
  evmos: [
    {
  ...
  osmo: [
    {
      ...
      jrpc: ['https://rpc.osmotest5.osmosis.zone', 'https://rpc.testnet.osl.zone'],
      rpc: [''],
      currencies: [
        {
          coinDenom: 'OSMO',
  ...
  cosmoshublocal: [
    {
      coinDenom: 'ATOM',
      minCoinDenom: 'uatom',
      imgSrc: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/cosmoshub/images/atom.svg',
      pngSrc: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/cosmoshub/images/atom.png',
      type: 'IBC',
      exponent: '6',
      cosmosDenom: 'ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2',
  ...
  osmosistestnet: [
    {
      coinDenom: 'OSMO',
      minCoinDenom: 'uosmo',
      imgSrc: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/osmosis/images/osmo.svg',
      pngSrc: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/osmosis/images/osmo.png',
      type: 'IBC',
      exponent: '6',
      cosmosDenom: 'ibc/2FBDAF744D3750564479C8E014CCD9522D59A264288E79644D139AE3203A9A71',
