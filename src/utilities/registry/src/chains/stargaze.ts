...
export default {
  ...
  tendermintRest: ['https://rpc.cosmos.directory/stargaze', 'https://rpc.stargaze-apis.com/', 'https://rpc-stargaze.pupmos.network', 'https://rpc-stargaze.ezstaking.dev'],
  evmRest: null,
  cosmosGRPC: ['https://rpc.stargaze-apis.com/', 'https://rpc-stargaze.pupmos.network', 'https://rpc-stargaze.ezstaking.dev'],
  tokens: [
    {
      name: 'Stargaze',
      ref: 'stars:STARS',
