...
export default {
  ...
  feeToken: 'uusdc',
  cosmosRest: ['https://rest.cosmos.directory/noble', 'https://noble-api.polkachu.com', 'https://api.mainnet.noble.strange.love'],
  tendermintRest: ['https://rpc.cosmos.directory/noble', 'https://noble-rpc.polkachu.com:443'],
  evmRest: null,
