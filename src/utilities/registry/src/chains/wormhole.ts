...
export default {
  ...
  feeToken: 'uworm',
  cosmosRest: ['https://rest.cosmos.directory/wormhole', 'https://wormchain-lcd.quickapi.com', 'https://tncnt-eu-wormchain-main-01.rpc.p2p.world/lcd'],
  tendermintRest: ['https://rpc.cosmos.directory/wormhole', 'https://wormchain-rpc.quickapi.com:443'],
  evmRest: null,
