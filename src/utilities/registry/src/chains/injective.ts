...
export default {
  ...
  feeToken: 'inj',
  cosmosRest: ['https://rest.cosmos.directory/injective', 'https://lcd.injective.network', 'https://injective-api.polkachu.com', 'https://injective-api.lavenderfive.com:443'],
  tendermintRest: ['https://rpc.cosmos.directory/injective', 'https://tm.injective.network'],
  evmRest: null,
